...
const Button: FC<ButtonProps> = ({
  ...
  <button
    ...
    className={clsx(
      ...
      "inline-flex items-center rounded-full border border-transparent px-4 py-2 text-sm font-medium shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
    )}
  >
    {children}
  </button>
